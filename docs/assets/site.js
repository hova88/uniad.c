...
const proofRungs = [
  ...
  {status: "Proved", title: "Operator fixtures", copy: "Projection, temporal carry, spatial sampling, top-k, and output serialization are compared against PyTorch fixtures.", next: "Next requirement", takeaway: "The operators must then compose correctly across frames, scene continuation, and reset."},
  ...
  {status: "Missing", title: "Checkpoint equivalence", copy: "This level would require every released tensor, learned operator, preprocessing transform, and output to match the pinned model.", next: "After equivalence", takeaway: "Numerical parity still would not establish task accuracy until official data and evaluation are run."},
